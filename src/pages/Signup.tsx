    ...
    <div className="min-h-screen auth-backdrop flex items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-6 animate-fade-in">
        <div className="text-center space-y-3">
          ...
          <h1 className="heading-serif text-3xl font-semibold text-foreground">Criar Conta</h1>
          <p className="text-sm text-muted-foreground heading-serif italic">Comece a cuidar do seu plantel hoje.</p>
        </div>
